...
:spring-platform-version: 2.0.5.RELEASE
:spring-platform-url: http://docs.spring.io/platform/docs/2.0.5.RELEASE/reference/htmlsingle/#appendix-dependency-versions
:across-version: 2.0.0-SNAPSHOT
:foreach-common-version: 1.0
:commons-collections-version: 4.1
:liquibase-version: 3.1.0
:querydsl-version: 3.6.9
:hikaricp-version: 2.4.5
