...
:spring-platform-url: http://docs.spring.io/platform/docs/1.1.1.RELEASE/reference/htmlsingle/#appendix-dependency-versions
:across-version: 1.1.2-SNAPSHOT
:foreach-common-version: 0.12
...
:asm-debug-web-module-version: 1.0.0.RELEASE
