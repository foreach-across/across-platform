...
:spring-platform-version: Brussels-SR6
:spring-platform-url: http://docs.spring.io/platform/docs/Brussels-SR6/reference/htmlsingle/#appendix-dependency-versions
