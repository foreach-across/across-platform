## Across Platform BOM
Please refer to the [Across wiki][] for all information regarding documentation, issue tracking and support.
...
[Across wiki]: https://foreach.atlassian.net/wiki/display/AX
